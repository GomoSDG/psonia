(ns psonia.panels.admin.vendors.core
  (:require [psonia.layouts.site :as site]
            [re-frame.core :as re-frame]
            [reagent.ratom :as ratom]
            [reagent.core :as r]
            [psonia.panels.components :refer [multi-level-navbar static-sidebar tablist tab]]
            [psonia.panels.admin.vendors.components :refer [vendor-list vendor-general-tab vendor-fica-documents-tab]]))
